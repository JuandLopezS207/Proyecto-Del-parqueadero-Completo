...
class MainApp(QMainWindow):
    ...
    def setImage(self,image,flag):              
        ...
        if flag==False:
            ...
            image.save("scanned_qr.png", "PNG")
            print("Código guardado como scanned_qr.png")

# Envía la imagen al servidor
            url = "http://localhost:80"
            spot = sendQR(url, "scanned_qr.png")
            ...
            if image:
                ...
                if spot:
                    ...
                    msgBox.setText(spot.decode("utf-8"))
                    msgBox.setWindowTitle("Puesto Asignado")
